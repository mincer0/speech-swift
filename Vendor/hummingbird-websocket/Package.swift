...
let package = Package(
    ...
    dependencies: [
        ...
        // Resolve the patched swift-websocket copy vendored alongside this
        // package. Keeping the dependency local avoids SwiftPM selecting a
        // second package identity for the same WSCore module.
